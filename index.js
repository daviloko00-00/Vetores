...
function listarnomealtura() {// função para listagem os nomes e alturas cadastrados
    ...
    texto += `\nMaior altura:   ${nomesAlturas[posMaior].nome},  ${maiorAltura}\n Menor altura: ${nomesAlturas[posMenor].nome}, ${menorAltura} `;// exibe as maiores e menores alturas com nomes e posições.
    alert(texto);
    console.log(texto);
    menu();
}
